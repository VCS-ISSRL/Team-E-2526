...
#define IO7 (IO7)              // Input/Output to payload plus (FINISH THIS)
#define IO6 (IO6)              // Input/Output to payload plus 
#define IO5 (IO5)              // Input/Output to payload plus
#define IO4 (IO4)              // Input/Output to payload plus
#define IO3 (IO3)               // Input/Output to payload plus
#define IO2 (IO2)               // Input/Output to payload plus
#define IO1 (IO1)               // Input/Output to payload plus
#define IO0 (IO0)              // Input/Output to payload plus 
//
